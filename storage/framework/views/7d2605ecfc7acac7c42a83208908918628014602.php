                    ...
                    <div class="ibox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row model-form-template">
                                        ...
                                        <div class="col-md-7">
                                            <input id="nama_pegawai" name="nama_pegawai" type="text" :class="$v.single.nama_pegawai.$invalid ? 'form-control error' : 'form-control'" placeholder="Contoh : Amirruzuhhad Gunes" v-model="single.nama_pegawai">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row model-form-template">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" name="password_pegawai" :class="$v.single.password_pegawai.$invalid ? 'form-control error' : 'form-control'" v-model="single.password_pegawai" placeholder="Generate otomatis" style="font-size: 9pt;" :readonly="formState == 'insert'">
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="border-top: 1px solid #dedede; margin-top: 20px;">
                            <div class="col-md-12" style="padding: 20px; text-align: right;">
                                <template v-if="formState == 'insert'">
                                     <?php if(Auth::user()->can('create', 'master data jabatan')): ?>
                                ...
                                <template v-if="formState == 'update'">
                                    ...
                                    <?php if(Auth::user()->can('update', 'master data jabatan')): ?>
                                    ...
                                    <?php if(Auth::user()->can('delete', 'master data jabatan')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sipenerang\tahura\resources\views/backend/master/pegawai/create.blade.php ENDPATH**/ ?>