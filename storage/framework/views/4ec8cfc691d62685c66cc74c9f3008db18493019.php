...
<col style="width: 150px">
  ...
  <tr>
    <td style="padding: 5px 3px" class="tg-vlyc" colspan="4">Memasuki Kawasan Tahura R. SOERJO untuk melakukan pendakian Gunung PUNDAK mulai tanggal <?php echo e(date('d/m/Y', strtotime($data->pd_tgl_naik))); ?> s/d <?php echo e(date('d/m/Y', strtotime($data->pd_tgl_turun))); ?> selama <?php echo $hari; ?>  hari, dengan ketentuan sebagai berikut :</td>
  </tr>
...
</table><?php /**PATH C:\xampp7\htdocs\sipenerang\tahura\resources\views/backend/pdf/berkas_pundak.blade.php ENDPATH**/ ?>