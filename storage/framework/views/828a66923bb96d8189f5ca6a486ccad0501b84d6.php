...
<col style="width: 150px">
  ...
  <tr>
    <td style="padding: 5px 3px" class="tg-vlyc" colspan="4">Memasuki Kawasan Tahura R. SOERJO untuk melakukan pendakian Gunung Arjuna-Welirang mulai tanggal <?php echo e(date('d/m/Y', strtotime($data->pd_tgl_naik))); ?> s/d <?php echo e(date('d/m/Y', strtotime($data->pd_tgl_turun))); ?> selama <?php echo $days; ?>  hari, dengan ketentuan sebagai berikut :</td>
  </tr>
...
</table><?php /**PATH C:\xampp\htdocs\project_lain\tahura\resources\views/backend/pdf/berkas.blade.php ENDPATH**/ ?>