<!-- Mainly scripts -->
<script src="{{ asset('public/backend/js/jquery-3.3.1.js') }}"></script>
<script src="{{ asset('public/backend/js/bootstrap-3.4.1.min.js') }}"></script>
...
<!-- Morris -->
<script src="{{ asset('public/backend/js/plugins/d3/d3.min.js') }}"></script>
<script src="{{ asset('public/backend/js/plugins/c3/c3.min.js') }}"></script>
