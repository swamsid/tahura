...
<col style="width: 150px">
  ...
  <tr>
    <td style="padding: 5px 3px" class="tg-vlyc" colspan="4">Memasuki Kawasan Tahura R. SOERJO untuk melakukan pendakian Gunung PUNDAK mulai tanggal {{ date('d/m/Y', strtotime($data->pd_tgl_naik)) }} s/d {{ date('d/m/Y', strtotime($data->pd_tgl_turun)) }} selama <?php echo $hari; ?>  hari, dengan ketentuan sebagai berikut :</td>
  </tr>
