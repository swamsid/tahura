                        ...
                        <div class="ibox-content" style="margin-bottom: 0px; padding-bottom: 0px; padding-top: 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-right" style="padding: 15px 5px 0px 5px; border-top: 1px solid #eee; margin-top: 15px;">
                                    <a href="{{ Route('wpadmin.pendaki.index') }}">
...
<?php } ?>
                ...
                axios.get('{{ Route("frontend.registrasi.resource") }}')
                        .then((response) => {
                            ...
                            setTimeout(function(e){
                                that.getData("{{ isset($_GET['id']) ? $_GET['id'] : 'null' }}")
                            }, 0);
            ...
            methods: {
                ...
                getData: function(id){
                    if(id != 'null'){
                        let that = this;
                        axios.get('{{ Route("wpadmin.pendaki.edit.getData") }}?id='+id)
                                .then((response) => {
...
<?php } ?>
                        ...
                        axios.post('{{ Route("wpadmin.pendaki.edit.update") }}', dataForm)
                                .then((response) => {
                                    console.log(response.data);
