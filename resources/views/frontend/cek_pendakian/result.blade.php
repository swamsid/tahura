                                ...
                                <div class="row" style="padding: 0px 20px;">
                                	<table width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="text-center" style="padding: 10px; color: #1ab394; border-left: 0px solid #ddd;">{{ $data->pd_nomor }}</th>
                                                <th class="text-center" style="padding: 10px; color: #1ab394; border-left: 1px solid #ddd;">{{ date('d/m/Y', strtotime($data->pd_tanggal_registrasi)) }}</th>
                                                <th class="text-center" style="padding: 10px; color: #1ab394; border-left: 1px solid #ddd;">{{ $data->pd_status }}</th>
                                            </tr>
                                        </thead>   
                                    </table>
                                </div>
                                ...
                                <div class="row" style="padding: 0px 20px; border-top: 1px solid #ddd; padding-top: 10px; margin-top: 20px;">
                                    ...
                                    <div class="col-md-12" style="margin-top: 5px;">
                                        <table class="table table-bordered" style="font-size: 9pt;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="text-center">{{ $data->pd_nomor }}</th>
                                                    <th class="text-center">{{ $data->pd_nama_ketua }}</th>
                                                    <th class="text-center">{{ ($data->pd_kewarganegaraan == "WNI") ? 'Indonesia' : 'Asing' }}</th>
                                                    <th class="text-center">{{ ($data->pd_jenis_kelamin == 'L') ? 'Laki-laki' : 'Perempuan' }}</th>
                                                    <th class="text-center">{{ $data->kabupaten }}</th>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
