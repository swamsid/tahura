        	...
        	@if(Session::has('message'))
	        	<div class="row" style="margin-top: 10px;">
	        		<div class="col-lg-8 col-lg-offset-2 text-center">
	        			<span class="label label-danger" style="font-weight: normal;">{{ Session::get('message') }}</span>
	        		</div>
	        	</div>
	        @endif
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" id="ibox-content" style="background-color: #ffffff; font-size: 14px">
                            <template v-if="!downloadingResource">
                                <form id="form-data" enctype="multipart/form-data" action="{{ Route('frontend.cek_pendakian.send') }}">
